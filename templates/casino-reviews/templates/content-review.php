<?php
//Background image from plugin options
$background_img = get_field('review_page_background_image', 'options');
//Background color from plugin options
$background_col = get_field('review_page_background_color', 'options')
                        ...
                        <tbody>
                            <tr class="rating">
                                ...
                                <td>
                                    ...
                                    $max_value = 5;
                                    if ($casino_rating) {
                                        echo '<span class="casino-rating">' . number_format($casino_rating, 1) . '</span> / 5';
                                    }
                                    ?>
                                </td>
                            <tr>
